...
const SectionElegirnosFortaleza = () => {
	...
	return (
		<section className="overflow-hidden bg-[#F9FAFB] dark:bg-[#1F2A37] pt-[60px] lg:pt-[80px] pb-[60px] lg:mb-[90px] lg:mx-[5%] lg:rounded-2xl select-none">
			<div className="container mx-auto">
				...
				<span className="absolute opacity-15 right-0 -mt-[150px]">
				...
				<div className="-mx-4 flex flex-wrap justify-center">
					<div className="select-none py-1 my-1">
						<div className="select-none cursor-pointer py-2 px-1 tracking-tight dark:text-gray-100 text-gray-900">

...
const SectionRedes = () => {
  ...
  const imgClassName = "shadow-xl shadow-gray-200 rounded-[40px] dark:shadow-gray-900/20 min-w-[280px]"
                      ...
                      <nav className="grid gap-2 mt-4 md:mt-10 justify-center" aria-label="Tabs" role="tablist" aria-orientation="vertical">
                        {redes.map((item, index) => (
                          <button key={index} aria-label="Redes"
                            className="max-w-[400px] rounded-lg border-[0.1rem] bg-slate-900 hover:border-blue-600 ring-1 dark:border-slate-300/20 dark:bg-[#111928]/40 ring-blue/30 dark:hover:bg-blue-800/40 dark:focus:bg-blue/50"

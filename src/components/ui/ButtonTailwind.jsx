const ButtonTailwind = ({ name, uri, color = "--color-section-3" }) => {
  const ariaLabel = `Más información sobre ${name}`;

  return (
    <div className="h-2 mx-auto justify-center items-center" >
      <a href={uri} aria-label={ariaLabel} className="relative inline-flex h-9 overflow-hidden rounded-full p-[1px] focus:outline-none  focus:ring-offset-slate-50">
